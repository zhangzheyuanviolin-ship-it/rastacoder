...
class LocalToolSkillCatalog {
  ...
  static const all = <LocalToolSkill>[
    ...
    LocalToolSkill(
      ...
      description: '模型只提交搜索关键词；API Key、返回数量和域名参数由用户预先配置。',
    ...
    LocalToolSkill(
      ...
      description: '模型只提交搜索关键词；API Key、结果数量、搜索类型和过滤条件由用户预先配置。',
    ...
    LocalToolSkill(
      ...
      description: '模型只提交搜索关键词；API Key、结果数量、新鲜度和摘要选项由用户预先配置。',
    ...
    LocalToolSkill(
      ...
      description: '模型只提交搜索关键词；API Key、结果数量、主题、深度和过滤条件由用户预先配置。',
